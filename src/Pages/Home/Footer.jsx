  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src={img} height={20} width={20} alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://m.facebook.com/profile.php?eav=Afb1m4W1qC6GEEu3QPLiSpRCqhtJ0lRq_58Fsyl_dMI015i7Eu7anX1xTa6t-JKb_9E&paipv=0"
            ...
            <li>
              <a
                href="https://www.instagram.com/mohit_aman_thakur/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/mohit-aman-thakur/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Mohit Aman</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
