...
import voting from "../../assets/voterproject1.jpg"
import guess from "../../assets/Guess.jpg"
import shake from "../../assets/Shake.jpg"
import imgc from "../../assets/imageclass.webp"
    ...
    portfolio: [
      {
        ...
        title: "Voting Boot",
        description:
          "Revolutionizing traditional voting norms with digitalization. Built with HTML, CSS, JavaScript for frontend, and Node.js and MySQL for backend.",
        link: "https://github.com/MOHITAMAN1998/E-voting",
      },
      {
        id: 2,
        src: tic,
        title: "Tic-Tac-Toe",
        description:
          "Experience the thrill of this classic game, elevated with React.js for a modern twist on timeless fun.",
        link: "https://github.com/MOHITAMAN1998/Tic-Tac-Toe",
      },
      {
        id: 3,
        src: guess,
        ...
        description:
          "Engage in a guessing challenge with this interactive JavaScript-powered game. Test your intuition and perseverance!",
        link: "https://github.com/MOHITAMAN1998/project1...-number-guessing-game-",
      },
      {
        id: 4,
        src: shake,
        title: "Shake Store App",
        description:
          "Delve into the world of shake ordering with this Android application. Designed with user-friendly interfaces for seamless ordering.",
        link: "https://github.com/MOHITAMAN1998/Smoothy-app-andriod",
      },
      {
        id: 5,
        src: imgc,
        ...
        description:
          "Dive deep into machine learning technologies with my CNN-based image classification project. Explore the future of AI and expand your horizons.",
        link: "https://github.com/MOHITAMAN1998/Image-classification-Using-CNN",
      },
    ],
  };
